...
import type { TransferListProps } from 'antd/lib/transfer/list';
import List from 'antd/lib/transfer/list';
import Search from 'antd/lib/transfer/search';
import type { RenderEmptyHandler } from 'antd/lib/config-provider';
import type { TransferListBodyProps } from 'antd/lib/transfer/ListBody';
import type { PaginationType } from 'antd/lib/transfer/interface';
import type { InputStatus } from 'antd/lib/_util/statusUtils';
export { TransferListProps } from 'antd/lib/transfer/list';
export { TransferOperationProps } from 'antd/lib/transfer/operation';
export { TransferSearchProps } from 'antd/lib/transfer/search';
...
declare class Transfer<RecordType extends TransferItem = TransferItem> extends React.Component<TransferProps<RecordType>, TransferState> {
    ...
    static Operation: ({ disabled, moveToLeft, moveToRight, leftArrowText, rightArrowText, leftActive, rightActive, className, style, direction, oneWay, }: import("antd/lib/transfer/operation").TransferOperationProps) => JSX.Element;
