...
import type { BuiltinPlacements, MenuClickEventHandler, MenuMode, SelectEventHandler, TriggerSubMenuAction, RenderIconType, ItemType, MenuRef } from 'rc-menu/lib/interface';
