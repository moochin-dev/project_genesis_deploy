...
import { NodeMouseEventHandler, NodeDragEventHandler, NodeDragEventParams, NodeMouseEventParams } from 'rc-tree/lib/contextTypes';
import { DataNode, IconType, Key, FlattenNode, DataEntity, EventDataNode, NodeInstance, ScrollTo, Direction, FieldNames, BasicDataNode } from 'rc-tree/lib/interface';
import { NodeListRef } from 'rc-tree/lib/NodeList';
...
declare class Tree<TreeDataType extends BasicDataNode = DataNode> extends React.Component<TreeProps<TreeDataType>, TreeState<TreeDataType>> {
    ...
    static TreeNode: React.FC<import("rc-tree/lib/TreeNode").TreeNodeProps<DataNode>>;
    destroyed: boolean;
